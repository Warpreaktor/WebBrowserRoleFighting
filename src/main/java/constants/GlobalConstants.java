...
public class GlobalConstants {
    ...
    public static final Double HEALTH_PER_STRENGTH_MULTIPLIER = 0.0;
     ...
     */
    public static final Double GLOBAL_DAMAGE_MULTIPLIER = 2.0;
    ...
    public static final int COST_OF_WEAPON_ATTACK = 1;
