...
public class FightServiceV1 {

    private static FightServiceV1 instance;
    ...
    public static FightServiceV1 getInstance() {
        if (instance == null) {
            instance = new FightServiceV1(
    ...
    public static FightServiceV1 newInstance() {
        instance = null;
        return getInstance();
    }
