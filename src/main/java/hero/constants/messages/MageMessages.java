...
public final class MageMessages {
     ...
     */
    public static final List<String> MAGE_ATTACK_MESSAGES = List.of(
     ...
     */
    public static final List<String> MAGE_MISSED_MESSAGES = List.of(
     ...
     */
    public static final List<String> MAGE_RELOAD_MESSAGES = List.of(
